...
namespace BookStore1.Controllers
{
    public class Books : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Title,PageCount,Authors,Description,Price,PressYear,StockCount,CategoryId,CreatedDate")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
